...
/**
 * Created by sunyungkim on 16. 8. 10..
 */
public class GetHotSpaceDataTask extends AsyncTask<String, Void, String> {
    private final String TAG = getClass().getName();
    private Context mContext;
    private Handler mHandler;
    private String mSpotName;

    public GetHotSpaceDataTask(Context context, Handler handler, String spotName) {
        mContext = context;
        mHandler = handler;
        mSpotName = spotName;
    }
    ...
    protected String doInBackground(String... args) {
        ...
        try {
            String urlString = Config.SERVER_POST_URL + Config.GET_HOT_SPACE_DATA_POST_PHP;
    ...
    protected void onPostExecute(String s) {
        ...
        if (s != null && mContext != null) {
            ...
            msg.obj = s.trim();
            msg.what = Config.SPACE_DATA_HANDLER;
